        ...
        if model == "advisor":
            ...
            try:#try to save and add advisor
                ...
                if referringUserSubmission.sendEmailConfirmation:
                    ...
                    message = "****Please don't reply to this email. You can contact us at www.physanthphylogeny.org/contact/ \n\nHello,\n\nThanks for submitting data to the Academic Phylogeny of Physical Anthropology. We just added the following connection from the data you sent.\n\nStudent:%(student)s\nAdvisor:%(advisor)s\n\nYou can see the updated tree at http://www.physanthphylogeny.org/tree.\n\nThanks again,\n\nAndrew Barr, Brett Nachman, and Liza Shapiro"%{"student":referringUserSubmission.student_first_name + " " + referringUserSubmission.student_last_name,"advisor":referringUserSubmission.advisor_first_name + " " + referringUserSubmission.advisor_last_name}
                    recipients = []
